  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="dropdown-content nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="/JspProject/project/aisw/professor/professor.jsp" title="교수">교수</a>
          <a class="dropdown-item" href="/JspProject/project/aisw/professor/emeritus-professor.jsp" title="명예교수">명예교수</a>
        </div>
      </li>
      <li class="dropdown-content nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="http://www.kangwon.ac.kr/www/selectBbsNttList.do?bbsNo=37&amp;key=1176&amp;)" title="학사공지&#40;새창열림&#41;"  target="_blank">학사공지</a>
          <a class="dropdown-item" href="/JspProject/project/aisw/bachelor/curriculum.jsp" title="교육과정">교육과정</a>
          <a class="dropdown-item" href="/JspProject/project/aisw/bachelor/subject.jsp" title="편성교과목">편성교과목</a>
          <a class="dropdown-item" href="/JspProject/project/aisw/bachelor/info.jsp" title="학사정보">학사정보</a>
          <a class="dropdown-item" href="/JspProject/project/aisw/bachelor/calendar.jsp" title="학사일정">학사일정</a>
        </div>
      </li>
      <li class="dropdown-content nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="/JspProject/project/aisw/admission/admission-guide.jsp" title="모집요강">모집요강</a>
        </div>
      </li>
      <li class="dropdown-content nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
